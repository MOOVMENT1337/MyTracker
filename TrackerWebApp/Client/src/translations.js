export const translations = {
  en: {
    ...
    admin: {
      ...
      deleteQueueConfirm:
        'Delete queue "{name}"? {count} task(s) will be permanently deleted. This action cannot be undone.',
      editName: "Edit Name",
    ...
    confirm: {
      ...
      deleteWithName:
        'Are you sure you want to delete "{key}: {summary}"? This action cannot be undone.',
    },
    errors: {
  ...
  ru: {
    ...
    admin: {
      ...
      deleteQueueConfirm:
        'Удалить очередь "{name}"? {count} задач(а/и) будут удалены безвозвратно. Это действие нельзя отменить.',
    ...
    createQueue: {
      ...
      keyHint:
        "Короткий уникальный идентификатор (только буквы, например DEV, QA, MOB)",
    },
    tooltips: {
    ...
    confirm: {
      ...
      deleteWithName:
        'Вы уверены, что хотите удалить "{key}: {summary}"? Это действие нельзя отменить.',
    },
    errors: {
